...
func (_IAllERC20 *IAllERC20Caller) Fee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _IAllERC20.contract.Call(opts, &out, "fee")
...
//
// Solidity: function fee() view returns(uint24)
func (_IAllERC20 *IAllERC20Session) Fee() (*big.Int, error) {
	return _IAllERC20.Contract.Fee(&_IAllERC20.CallOpts)
}

// Fee is a free data retrieval call binding the contract method 0xddca3f43.
//
// Solidity: function fee() view returns(uint24)
func (_IAllERC20 *IAllERC20CallerSession) Fee() (*big.Int, error) {
	return _IAllERC20.Contract.Fee(&_IAllERC20.CallOpts)
}
